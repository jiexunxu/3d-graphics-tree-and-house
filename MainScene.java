...
public class MainScene extends Frame implements Runnable, KeyListener {
	public int W, H;
	...
	public static void main(String[] args) {
		...
		var height = 720;
		var slow_factor = 0.5;
		var f = new MainScene (width, height, slow_factor);
		f.setSize(width,height);
		f.setVisible(true);
		f.setLayout(new FlowLayout());
	}

	public MainScene(int width, int height, double slow_factor) {
		setLayout(new BorderLayout());

		W = width;      // FIND THE RESOLUTION OF THE JAVA APPLET
		H = height;
